...
HD_PWD='C:/Users/Hassan/Documents/GitHub/SignedSPM/SequentialMultiplier/SequentialMultiplier.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log SPM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source SPM.tcl
